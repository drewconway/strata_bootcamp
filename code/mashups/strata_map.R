...
click.plot<-click.plot+geom_point(data=click.counts, aes(x=lon, y=lat, color="red", alpha=0.65, size=V1))+
    scale_colour_manual(values=c("grey"="grey","red"="red"),legend=FALSE)+scale_alpha(legend=FALSE)+scale_size(legend=FALSE)+
